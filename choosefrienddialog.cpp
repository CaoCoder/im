    ...
    : userId(userId)
{
    ...
    QString style = "QCheckBox { background-color:rgb(37,37,37);background-color: transparent; } QCheckBox::indicator { width: 20px; height: 20px; image: url(:/resource/image/unchecked.png);}";
    ...
    nameLabel->setStyleSheet("QLabel {background-color: rgb(37, 37, 37);background-color: transparent;}");
...
void ChooseFriendItem::paintEvent(QPaintEvent *event)
{
    ...
    if (isHover) {
        // 绘制成深色
        painter.fillRect(this->rect(), QColor(60, 60, 60));
    } else {
        // 绘制成浅色
        painter.fillRect(this->rect(), QColor(37, 37, 37));
    }
}
...
ChooseFriendDialog::ChooseFriendDialog(QWidget* parent, const QString& userId) : QDialog(parent), userId(userId) {
    ...
    this->setStyleSheet("QDialog { background-color: rgb(37, 37, 37);}");
...
void ChooseFriendDialog::initLeft(QHBoxLayout *layout)
{
    ...
    scrollArea->verticalScrollBar()->setStyleSheet("QScrollBar:vertical { width: 2px; background-color: rgb(37, 37, 37); }");
    ...
    totalContainer->setStyleSheet("#totalContainer { background-color: rgb(37, 37, 37); }");
...
void ChooseFriendDialog::initRight(QHBoxLayout *layout)
{
    ...
    tipLabel->setStyleSheet("QLabel { background-color: rgb(37, 37, 37);font-size: 16px; font-weight: 700}");
    ...
    selectedContainer->setStyleSheet("#selectedContainer { background-color: rgb(37, 37, 37); }");
    ...
    // 6. 创建底部按钮
    QString style = "QPushButton { color: rgb(7, 191, 96); background-color: rgb(60, 60, 60); border: none; border-radius: 5px;}";
    style += "QPushButton:hover { background-color: rgb(220, 220, 220); } QPushButton:pressed { background-color: rgb(60 , 60 , 60); }";
