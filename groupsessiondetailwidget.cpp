...
GroupSessionDetailWidget::GroupSessionDetailWidget(QWidget* parent) : QDialog(parent) {
    ...
    this->setAttribute(Qt::WA_DeleteOnClose);
     this->setStyleSheet("background-color: rgb(37, 37, 37); color: rgb(200, 200, 200);");
    ...
    modifyBtn->setStyleSheet("QPushButton {color: rgb(0, 0, 0);background-color:  rgb(137, 217, 97); border: none; background-color: transparent; } QPushButton:pressed { background-color: rgb(230, 230, 230); }");
    ...
    QString btnStyle = "QPushButton {color: rgb(0, 0, 0);  border: 1px solid rgb(90, 90, 90); border-radius: 5px; background-color: transparent;background-color:  rgb(137, 217, 97);}";
