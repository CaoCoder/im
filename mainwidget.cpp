...
void MainWidget::initMainWindow()
{
    ...
    windowLeft->setFixedWidth(45);
    windowMid->setFixedWidth(230);
    windowRight->setMinimumWidth(450);
    this->setWindowFlags(Qt::FramelessWindowHint);

    // 设置窗口为黑夜模式
    windowLeft->setStyleSheet("QWidget { background-color: rgb(45, 47, 51); }");
    windowMid->setStyleSheet("QWidget { background-color: rgb(17, 17, 17); }");
...
void MainWidget::initLeftWindow()
{
    ...
    settingsBtn->setIcon(QIcon(":/resource/image/settings.png"));
    settingsBtn->setStyleSheet("QPushButton { border:none;background-color: transparent; }");
    layout->addWidget(settingsBtn, 1, Qt::AlignBottom | Qt::AlignHCenter);  // 将设置按钮放置在底部
    connect(settingsBtn, &QPushButton::clicked, this, [=]() {
        ConfigWindow *conf = new ConfigWindow(this);
        qDebug() << "已经被点击";
        conf->setWindowModality(Qt::WindowModal);  // 设置窗口为模态窗口
        conf->show();
    });
}
...
void MainWidget::initMidWindow()
{
    ...
    windowMid->setLayout(layout);
        // windowMid->setStyleSheet("QWidget { border-right: 1px solid rgb(37, 37, 37); }");
    searchEdit = new QLineEdit();
    searchEdit->setFixedHeight(30);
    searchEdit->setPlaceholderText("搜索");
    searchEdit->setStyleSheet("QLineEdit {  border-right: 1px solid rgb(37, 37, 37);border-radius: 5px; background-color: rgb(37, 37, 37); color: white; padding-left: 5px;}");

    addFriendBtn = new QPushButton();
    addFriendBtn->setFixedSize(30, 30);
    addFriendBtn->setIcon(QIcon(":/resource/image/cross.png"));
    QString style = "QPushButton { border-radius: 5px; background-color: rgb(37, 37, 37); color: white; }";
    style += " QPushButton:pressed { background-color: rgb(75, 75, 75); }";
...
void MainWidget::initRightWindow()
{
    ...
    titleWidget->setStyleSheet("#titleWidget {  border-bottom: 1px solid rgb(37, 37, 37); border-left: 1px solid rgb(37, 37, 37); }");
    vlayout->addWidget(titleWidget);

    QHBoxLayout* hlayout = new QHBoxLayout();
    hlayout->setSpacing(0);
    hlayout->setContentsMargins(0, 15, 5, 0);
    titleWidget->setLayout(hlayout);

    sessionTitleLabel = new QLabel();
    sessionTitleLabel->setStyleSheet("QLabel { font-size: 22px; color: white; border-bottom: 1px solid rgb(37, 37, 37);}");
#if TEST_UI
    ...
    closeButton->setIcon(QIcon(":/resource/image/close.png"));
    closeButton->setIconSize(QSize(17, 17));
    closeButton->setFixedSize(35, 25);
    closeButton->setStyleSheet("QPushButton { border:none; background-color: rgb(17, 17, 17); } "
    ...
    extraBtn->setStyleSheet("QPushButton { border:none; background-color: rgb(17, 17, 17); }"
