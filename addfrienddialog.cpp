...
FriendResultItem::FriendResultItem(const UserInfo &userInfo) : userInfo(userInfo)
{
    ...
    nameLabel->setStyleSheet("QLabel { color: rgb(200 , 200 , 200); font-size: 16px; font-weight: 700;}");
    ...
    descLabel->setStyleSheet("QLabel { color: rgb(200 , 200 , 200); font-size: 14px; }");
    ...
    addBtn->setText("添加好友");
    QString btnStyle = "QPushButton { border: none; background-color: rgb(137, 217, 97); color: rgb(34, 34, 34); border-radius: 10px;} ";
    btnStyle += "QPushButton:pressed { background-color: rgb(60 , 60 , 60); }";
...
void FriendResultItem::clickAddBtn()
{
    ...
    addBtn->setText("已申请");
    addBtn->setStyleSheet("QPushButton { border:none; color: rgb(34, 34, 34); background-color: rgb(60 , 60 , 60); border-radius: 10px;}");
}
...
AddFriendDialog::AddFriendDialog(QWidget* parent) : QDialog(parent) {
    ...
    QString style = "QLineEdit {color: rgb(200 , 200 , 200); border: none; border-radius: 10px; font-size: 16px; background-color:   rgb(60, 60, 60); padding-left: 5px;}";
    ...
    QString btnStyle = "QPushButton { color: rgb(200 , 200 , 200); border: none; background-color:   rgb(60, 60, 60); border-radius: 10px; }";
    btnStyle += "QPushButton:hover { background-color: rgb(220, 220, 220); } QPushButton:pressed { background-color: rgb(60 , 60 , 60); } ";
...
void AddFriendDialog::initResultArea()
{
    ...
    scrollArea->verticalScrollBar()->setStyleSheet("QScrollBar:vertical {width: 2px; background-color: rgb(34, 34, 34);}");
    ...
    resultContainer->setStyleSheet("#resultContainer { color: rgb(200 , 200 , 200); border: none; background-color: rgb(34, 34, 34); } ");
