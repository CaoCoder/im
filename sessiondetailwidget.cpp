...
SessionDetailWidget::SessionDetailWidget(QWidget* parent, const UserInfo& userInfo) : QDialog(parent), userInfo(userInfo) {
    ...
    this->setStyleSheet("QWidget {color: rgb(200 , 200 , 200); background-color:  rgb(37, 37, 37); }");
    ...
    // 3. 添加 "创建群聊" 按钮
    AvatarItem* createGroupBtn = new AvatarItem(QIcon(":/resource/image/cross.png"), "邀请");
    ...
    QString style = "QPushButton { color: rgb(0, 0, 0); border: 1px solid rgb(90, 90, 90); border-radius: 5px; background-color:  rgb(137, 217, 97);} ";
    style += "QPushButton:pressed { background-color: rgb(60, 60, 60); }";
...
void SessionDetailWidget::clickDeleteFriendBtn()
{
    ...
    // result->styleSheet("QMessageBox { background-color: rgb(37, 37, 37); }");
