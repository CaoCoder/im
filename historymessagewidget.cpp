...
HistoryMessageWidget::HistoryMessageWidget(QWidget* parent) : QDialog(parent) {
    ...
    searchEdit->setStyleSheet("QLineEdit { border: none; border-radius: 10px; background-color: rgb(60, 60, 60); font-size: 16px; padding-left: 10px; }");
    ...
    QString btnStyle = "QPushButton { border: none; background-color: rgb(60, 60, 60); border-radius: 10px; }";
